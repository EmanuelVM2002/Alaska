...
namespace Alaska.Web.Controllers
{
    public class ManagersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomEmpleado,CedEmpleado,ApeEmpleado,EdadEmpleado")] Manager manager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomEmpleado,CedEmpleado,ApeEmpleado,EdadEmpleado")] Manager manager)
        {
            if (id != manager.Id)
            {
                return NotFound();
