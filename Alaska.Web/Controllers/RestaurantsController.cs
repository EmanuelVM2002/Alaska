...
namespace Alaska.Web.Controllers
{
    public class RestaurantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomRestaurante")] Restaurant restaurant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomRestaurante")] Restaurant restaurant)
        {
            if (id != restaurant.Id)
            {
                return NotFound();
